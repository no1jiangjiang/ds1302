...
#ds1302
set_location_assignment  PIN_J2 -to  sclk
set_location_assignment  PIN_K2 -to  CE
set_location_assignment  PIN_K1 -to  sda
...
# set_location_assignment PIN_T6    -to csn 
# set_location_assignment PIN_R6    -to rasn
# set_location_assignment PIN_T5    -to casn
# set_location_assignment PIN_N1    -to wen 
...
# set_location_assignment PIN_F6  -to   vsync_ov5640
# set_location_assignment PIN_D1  -to   href 
# set_location_assignment PIN_D5  -to   pclk 
# set_location_assignment PIN_F5  -to   din[0]
# set_location_assignment PIN_G5  -to   din[1] 
# set_location_assignment PIN_D4  -to   din[2]   
# set_location_assignment PIN_M1  -to   din[3] 
# set_location_assignment PIN_F3  -to   din[4] 
# set_location_assignment PIN_F2  -to   din[5] 
# set_location_assignment PIN_E5  -to   din[6] 
# set_location_assignment PIN_C3  -to   din[7] 
# set_location_assignment PIN_D3  -to   xclk_24M 
# set_location_assignment PIN_F1  -to   reset 
# set_location_assignment PIN_G2  -to   pwdh  
